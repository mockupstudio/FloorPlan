...
public class RoomPartFit {
	...
	public boolean isInside(Polygon floorPlan,Polygon room)
	{
		
		
		Point2D.Double topLeft = new Point2D.Double(room.xpoints[1],room.ypoints[1]);
		Point2D.Double topRight = new Point2D.Double(room.xpoints[2],room.ypoints[2]);
		Point2D.Double bottomLeft = new Point2D.Double(room.xpoints[0],room.ypoints[0]);
		Point2D.Double bottomRight = new Point2D.Double(room.xpoints[3],room.ypoints[3]);
	...
	public double getOffset(Polygon floorPlan,Polygon room)
	{
	...
	public boolean isAligned(Polygon floorPlan,Polygon room)
	{
	...
	public Line2D.Double getAlignmentLine(Polygon floorPlan,Polygon room)
	{
		int[] xCoordinates = floorPlan.xpoints;
		int[] yCoordinates = floorPlan.ypoints;
		Line2D.Double vertLine = new Line2D.Double(room.xpoints[0],room.ypoints[0],room.xpoints[1],room.ypoints[1]);
		Line2D.Double horzLine = new Line2D.Double(room.xpoints[1],room.ypoints[1],room.xpoints[2],room.ypoints[2]);
